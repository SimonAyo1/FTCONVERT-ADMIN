        ...
        <div className="profile">
          ...
          <div className="profile__stats">
            ...
            <div className="profile__stat">
              ...
              <div className="profile__value">
                {reqData.customer}<div className="profile__key">Customers</div>
              </div>
            </div>
            <div className="profile__stat">
              ...
              <div className="profile__value">
                {reqData.transactionFee}%<div className="profile__key">TX Fee</div>
              </div>
            </div>
          </div>
          <div className="profile__stats">
            <div className="profile__stat">
              ...
              <div className="profile__value" style={{ fontSize: 14 }}>
                {reqData.phoneNumber}
                <div className="profile__key">Phone Number</div>
              </div>
            </div>
            <div className="profile__stat">
              <div className="profile__icon profile__icon--blue">
              ...
              <div className="profile__value" style={{ fontSize: 14 }}>
                {reqData.fullName}
                <div className="profile__key">Full Name</div>
              </div>
            </div>
            <div className="profile__stat">
              <div className="profile__icon profile__icon--pink">
          ...
          <div style={{ marginTop: 20 }}>
            <div className="profile__value" style={{ fontSize: 15 }}>
              Payment Url: <a href={reqData.payment_url}>{reqData.payment_url}</a>
            </div>
            <div className="profile__value" style={{ fontSize: 15 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', marginTop: 40 }}>
            <div>
              <Button variant="outlined" color={isDisabled ? 'secondary' : 'error'} onClick={handleMerchantDisablility}>
                {isdisabling ? 'Processing...' : isDisabled ? 'Enable Merchant' : 'Disable Merchant'}
              </Button>
            </div>
            <div>
              <MerchantDrawer docId={docId} />
            </div>
          </div>
        </div>
      </div>
